 ...
 */
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  16               // Seconds /// BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
  #define WATCH_TEMP_INCREASE 4               // Degrees Celsius /// BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
#endif
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        60 // Seconds /// BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
  #define THERMAL_PROTECTION_BED_HYSTERESIS     2 // Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD                120 // Seconds /// BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
 ...
 */
#define HOTEND_IDLE_TIMEOUT /// BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
#if ENABLED(HOTEND_IDLE_TIMEOUT)
  #define HOTEND_IDLE_TIMEOUT_SEC (3*60)    // (seconds) Time without extruder movement to trigger protection // BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
...
//#define XY_COUNTERPART_BACKOFF_MM 0         // (mm) Backoff X after homing Y, and vice-versa
 ...
 #define QUICK_HOME                          // If G28 contains XY do a diagonal move first /// BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
 ...
 */
#define DEFAULT_STEPPER_DEACTIVE_TIME 60 /// BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
...
//#define BACKLASH_COMPENSATION
  ...
  #define BACKLASH_GCODE /// BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING /// BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SDCARD_READONLY                 // Read-only SD card (to save over 2K of flash) /// BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
  ...
  #define NO_SD_AUTOSTART                 // Remove auto#.g file support completely to save some Flash, SRAM /// BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
   ...
   */
  #define SDCARD_CONNECTION ONBOARD /// BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
 ...
 */
   ...
   */
  #define DISPLAY_SLEEP_MINUTES 0  // (minutes) Timeout before turning off the screen
...
// G2/G3 Arc Support
//
#define ARC_SUPPORT                   // Requires ~3226 bytes  /// BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
 ...
 */
#define DIRECT_STEPPING /// BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
 ...
 */
#define EMERGENCY_PARSER /// BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
...
#define EXPERIMENTAL_I2CBUS  // BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
