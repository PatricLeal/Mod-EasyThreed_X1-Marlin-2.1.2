 ...
 * BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
 */
...
/**
 * ET-4000 V2(easythreed x1/nano/labists x1) AUX pins:
 *               PWM 
 *         VCC  MOSI  TX1  RX1  SCL  SDA
 *          5V   D12  D11  D10  D17  D16
 *          0V   D31  D30  D29  D28  D27
 *         GND   SCK   A4   A3   A2   A1
 */
...
//
  ...
  #define SD_DETECT_PIN                       -1
    ...
    #define LCD_SCREEN_ROTATE              0   // BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1 // 0, 90, 180, 270
    ...
    #define BTN_EN1                           29  // BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
    #define BTN_EN2                           28  // BOARD ET-4000 V2  EASYTHREED X1 - NANO - MIKE \ LABISTS X1
  #endif
